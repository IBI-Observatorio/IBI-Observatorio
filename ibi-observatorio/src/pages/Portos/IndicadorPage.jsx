  ...
  if (erro) {
    return (
      <div className="min-h-screen bg-gray-900 pt-40 text-center">
        ...
        <Link to="/portos" className="mt-4 inline-flex items-center gap-2 text-ibi-blue">
      ...
      <section className="border-b border-gray-800 bg-gradient-to-br
        ...
        <div className="container mx-auto px-6">
          <div className="mb-6 flex flex-wrap items-center gap-2 text-sm text-gray-400">
            <Link to="/portos" className="hover:text-ibi-blue transition-colors">Indicadores</Link>
            <span>/</span>
            <Link to={`/portos/${slugCluster}`} className="hover:text-ibi-blue transition-colors">
